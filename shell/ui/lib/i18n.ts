...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "setup.welcome.p1": "Wandesk is a desktop where an AI lives and works. Every app on it is a small website that the AI can read, edit and rebuild, and you can ask for new ones in plain words.",
    "setup.welcome.p2": "It runs on a model you bring yourself. Setup takes one step: connect a model. Then your desktop is ready.",
    "setup.model.title": "Connect a model",
    "setup.model.p1": "Paste any OpenAI-compatible endpoint, your API key and a model id. Wandesk sends one test request before continuing.",
    "setup.done.title": "You're all set",
    "setup.done.p1": "The model answered and the connection is saved. You can change it any time from Settings on the desktop.",
