...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "setup.hint": "Wandesk runs on your own model. Paste any OpenAI-compatible endpoint, your API key and a model id. Your desktop opens as soon as the model answers.",
    ...
    "setup.foot": "You can change the connection later in Settings.",
    "taskbar.apps": "Apps",
