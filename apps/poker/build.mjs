// This app's build: src/ → public/. After changing src/, run in this directory:
//   npm install && npm run build
// The output (public/app.js + app.css + index.html) lands back here; the window
// refreshes to pick it up. The host takes no part in compiling and carries no deps.
