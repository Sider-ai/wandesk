// Reading scroll: overall verdict + oracle verse + do's/don'ts + interpretation.
// Unrolls like a temple fortune slip.
    ...
    <div className={`fo-scroll fo-tone-${tone}`}>
      ...
      <div className="fo-scroll-paper">
        <div className="fo-signrow">
          ...
          <span className="fo-sign-seal" aria-hidden>☯</span>
        </div>

        <div className="fo-sec-label">Oracle Verse</div>
        ...
        <div className="fo-gb">
          <div className="fo-gb-col fo-gb-col-good">
            <div className="fo-gb-key fo-gb-good" title="Favorable">✓</div>
          ...
          <div className="fo-gb-col fo-gb-col-bad">
            <div className="fo-gb-key fo-gb-bad" title="Avoid">✕</div>
            <div className="fo-gb-tags">
        ...
        <div className="fo-sec-label">Interpretation</div>
