  ...
  return (
    <section className="space-y-4">
      <div className="rounded-[13px] border px-4 py-4" style={{ background: "#fff", borderColor: "rgba(0,0,0,0.08)" }}>
        <div className="mb-3 text-[12px] font-semibold uppercase tracking-wide" style={{ color: "rgba(0,0,0,0.35)" }}>__T_SETTINGS_CONTEXT_ROUNDS__</div>
      ...
      <div className="flex justify-end"><button className="rounded-[9px] bg-[#5c4332] px-5 py-2 text-[13px] font-semibold text-white transition-colors hover:bg-[#3d2a1e]" onClick={onSave}>__T_SETTINGS_SAVE__</button></div>
    </section>
  );
}
